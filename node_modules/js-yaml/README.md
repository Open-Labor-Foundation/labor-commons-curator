...
__Recommended loading way.__ Parses `string` as single YAML document. Returns either a
...
__Use with care with untrusted sources__. The same as `safeLoad()` but uses
